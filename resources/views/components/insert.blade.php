...
<div class="container-fluid">
    <div class="container py-5">
        <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 500px;">
            <div class="btn btn-sm border rounded-pill text-primary px-3 mb-3">Add <?php echo $title ?></div>
            <h1 class="mb-4">Create a New <?php echo $title ?></h1>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div>    
                @if($type == 'project')
                        <form method="post" enctype="multipart/form-data" name="<?php echo $type ?>" action="{{route('project.store')}}">
                    @elseif($type == 'event')
                        <form method="post" enctype="multipart/form-data" name="<?php echo $type ?>" action="{{route('event.store')}}">
                    @else
                        <form method="post" enctype="multipart/form-data" name="<?php echo $type ?>" action="{{route('news.store')}}">
                    @endif
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="title"
                                        name="title" placeholder="<?php echo $title ?> Title"
                                        required>
                                ...
                                <div class="col-md-{{$align}}">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="{{$type}}_author"
                                            name="author" placeholder="{{$type}} Author" required>
                                ...
                                <div class="col-md-{{$align}}">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="{{$type}}_date"
                                            name="date" placeholder="{{$type}} Date" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="{{$type}}_team"
                                            name="team" placeholder="{{$type}} Team Members Names" required>
                                        <label for="{{$type}}">{{$title}} Team Members Names</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="{{$type}}_active" name="active" value="on">
                                ...
                                <div class="col-md-{{$align}}">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="date"
                                            name="date1" placeholder="Date" required>
                                ...
                                <div class="col-md-{{$align}}">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="date1"
                                            name="date2" placeholder="Date" required>
                            ...
                            @if($type != 'event')
                                <div class="col-md-<?php echo $align ?>">
                                    <div class="form-floating">
                                        <input type="file" id="input-th" class="form-control" 
                                            name="thumbnail" accept="image/*" onchange="verifyFileUpload('input-th','0.75')" required>
                                        <label for="<?php echo $type ?>_image">Thumbnail</label>
                                ...
                                <div class="col-md-<?php echo $align ?> ">
                                    <div class="form-floating">
                                        <input type="file" id="input-t" class="form-control" 
                                            name="top" accept="image/*" onchange="verifyFileUpload('input-t','0.75')" required>
                                        <label for="<?php echo $type ?>_image">Top image</label>
                            ...
                            @else
                                <div class="col-md-<?php echo $align ?>">
                                    <div class="form-floating">
                                        <input type="file" id="input-th" class="form-control" 
                                            name="thumbnail" accept="image/*" onchange="verifyFileUpload('input-th','1.3333333333')" required>
                                        <label for="<?php echo $type ?>_image">Thumbnail</label>
                                ...
                                <div class="col-md-<?php echo $align ?> ">
                                    <div class="form-floating">
                                        <input type="file" id="input-t" class="form-control" 
                                            name="top" accept="image/*" onchange="verifyFileUpload('input-t','1.3333333333')" required>
                                        <label for="<?php echo $type ?>_image">Top image</label>
                                        <p class="d-none" id="input-h"><small>  Note: the top image needs to have a 14/2 ratio (ex: 1400 x 200)</small></p>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="file" id="input-id" class="form-control"
                                        name="image[]" accept="image/*" onchange="verifyFilesUpload('input-id','1')" multiple required>
                                    <label for="<?php echo $type ?>_image">Images</label>
                            ...
                            <!-- For the layout -->
                            <input type="hidden" class="form-control" id="layout" name="layout" placeholder="0" value="0">

                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" id="mySubmit" type="submit">
                                    <i class="fas fa-plus me-2"></i> Add <?php echo $title ?>
                                </button>
                            </div>
